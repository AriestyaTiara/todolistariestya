    ...
    <style>
        * {
        ...
        body {
            ...
            padding: 20px;
            background: url('tya3.jpg') no-repeat;
        ...
        .task-item {
            background: #fc72f1 /* Warna lebih terang */
        ...
        .task-list {
            ...
            background-color: #fcc5f8; /* Warna latar belakang untuk membedakan */
